"""Joel Mashana Dissertation Project file for ensuring the package is executable
as `joel-mashana-dissertation-project` and `python -m joel_mashana_dissertation_project`
"""
import importlib
