...
# joel_mashana_dissertation_project documentation build
...
from joel_mashana_dissertation_project import __version__ as release
...
htmlhelp_basename = "joel_mashana_dissertation_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "joel_mashana_dissertation_project.tex",
        "joel_mashana_dissertation_project Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "joel_mashana_dissertation_project",
        "joel_mashana_dissertation_project Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "joel_mashana_dissertation_project",
        "Project joel_mashana_dissertation_project codebase.",
        "Data-Science",
    )
]
